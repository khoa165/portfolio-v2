...
const mainExperience = {
  title: 'Student Web & Application Developer',
  location: 'UW-Madison', date: 'October 2019 - now',
  summary: 'Provided more than 50 hours technical support to the Department of Medical Physics.',
  contributions: [
...
const extraExperiences = [
  ...
  location: 'UW-Madison', date: 'September 2019 - now',
  summary: 'Facilitating weekly individual and group tutoring to university housing residents taking Mathematics courses through Math 222 (Calculus II).',
  contributions: [
  ...
  location: 'UW-Madison', date: 'August 2019 - May 2019',
  summary: 'Provided more than 250 hours of exceptional customer service with the goal of making guests feel welcome and satisfied.',
  contributions: [
...
class Experiences extends React.Component {
  ...
  toggle = () => this.setState({expandMoreExperience: !this.state.expandMoreExperience});
  ...
  render() {
    return (
      <Container>
        ...
        : null}
        {this.state.expandMoreExperience ? 
          <a href="#experiences" onClick={this.goToExperiencesAndToggle}>See less</a>
        : null}
      </Container>
